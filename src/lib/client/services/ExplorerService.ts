...
export class ExplorerService {
   ...
   * @throws ApiError
   */
  public static navigateExplorerNavigatePost(requestBody: Record<string, any>): CancelablePromise<DirectoryListingResponse> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static getPropertiesExplorerPropertiesGet(path: string): CancelablePromise<FilePropertyResponse> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static createDirectoryExplorerCreateDirectoryPost(requestBody: CreateDirectoryRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static prepareUploadExplorerUploadPreparePost(requestBody: UploadPrepareRequest): CancelablePromise<UploadPrepareResponse> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static checkUploadConflictsExplorerUploadConflictsPost(requestBody: UploadPrepareRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static streamUploadFileExplorerUploadStreamOperationIdPut(
    operationId: string,
    filename: string,
    size?: number,
    ...
    return __request(OpenAPI, {
      method: "PUT",
      url: "/explorer/upload/stream/{operation_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static uploadFilesExplorerUploadPost(formData: Body_upload_files_explorer_upload_post): CancelablePromise<UploadResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/explorer/upload",
      formData: formData,
   ...
   * @throws ApiError
   */
  public static deleteItemsExplorerDeleteDelete(requestBody: DeleteRequest): CancelablePromise<DeleteResponse> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/explorer/delete",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static renameItemExplorerRenamePost(requestBody: RenameRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/explorer/rename",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static downloadFileExplorerDownloadGet(path: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static clipboardCopyExplorerClipboardCopyPost(requestBody: ClipboardCopyRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static clipboardCutExplorerClipboardCutPost(requestBody: ClipboardCopyRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static clipboardPasteExplorerClipboardPastePost(requestBody: ClipboardPasteRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static clipboardStatusExplorerClipboardStatusGet(sessionId: string): CancelablePromise<ClipboardStatusResponse> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static clipboardClearExplorerClipboardClearDelete(sessionId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
   ...
   * @throws ApiError
   */
  public static deleteBookmarkExplorerBookmarksBookmarkIdDelete(bookmarkId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/explorer/bookmarks/{bookmark_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static searchFilesExplorerSearchPost(requestBody: SearchRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/explorer/search",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getOperationStatusExplorerOperationsOperationIdGet(operationId: string): CancelablePromise<OperationResponse> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteOperationExplorerOperationsOperationIdDelete(operationId: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/explorer/operations/{operation_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static cancelOperationExplorerOperationsOperationIdCancelPost(operationId: string): CancelablePromise<OperationResponse> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static updateExplorerConfigExplorerConfigPut(requestBody: ConfigUpdateRequest): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "PUT",
      url: "/explorer/config",
      body: requestBody,
